			...
			<ul class="rslides w3layouts agileits" id="slider">
				<li>
						<div class="layer w3layouts agileits-banner agileits-banner1">
							<h3>Make sure you smell great</h3>
							<p>Try before buying bigger sizes. We give you the opportunity to discover if you really love that new fragrance.</p>
			...
			<nav class="navbar navbar-default cl-effect-5"  id="cl-effect-5">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li><a class="active scroll" href="<?php echo site_url('Shop');?>"<span data-hover="men">MEN</span></a></li> 
